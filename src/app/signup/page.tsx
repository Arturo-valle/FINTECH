    ...
    <div className="min-h-screen bg-secondary/50 flex flex-col items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md mx-auto shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-headline text-2xl">Únete al Hub</CardTitle>
          <CardDescription>Crea tu cuenta para empezar a conectar con el ecosistema fintech.</CardDescription>
        </CardHeader>
        <CardContent>
